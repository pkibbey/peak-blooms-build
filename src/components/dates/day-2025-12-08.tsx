          ...
          <HoverCardPositioner side="right" align="start">
            <HoverCardContent className="md:w-96">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-popover-foreground">
                  Static components improve performance. Dynamic components
                  turned out to add too much complexity. The cost-benefit of
                  using static components was far more beneficial to this
                  project.
                </p>
              </div>
            </HoverCardContent>
