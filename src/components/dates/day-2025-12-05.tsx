          ...
          <HoverCardPositioner side="right" align="start">
            <HoverCardContent className="md:w-96">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-popover-foreground">
                  Quantity selectors improve shopping experience. Inline
                  quantity selection streamlines the shopping process and
                  reduces clicks.
                </p>
              </div>
            </HoverCardContent>
            ...
            <HoverCardContent className="md:w-96">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-popover-foreground">
                  ...
                  purchases from previous orders improves customer experience
                  for frequent buyers.
                </p>
              </div>
            </HoverCardContent>
