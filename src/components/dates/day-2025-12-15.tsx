            ...
            <HoverCardContent className="md:w-96">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-popover-foreground">
                  Build verification prevents deployment issues. Testing builds
                  in production-like environments catches environment-specific
            ...
            <HoverCardContent className="md:w-96">
              <div className="flex items-start gap-3">
                ...
                <p className="text-sm text-popover-foreground">
                  ...
                  Well-documented processes and guidelines help new team members
                  onboard faster.
                </p>
              </div>
            </HoverCardContent>
